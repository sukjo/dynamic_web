export const RECIPE_LIST = [
  {
    title: "Kuzumochi",
    imgSrc: require("../assets/kuzumochi.jpg"),
    ...
    ingredients: [
      { measure: "100 g (3 1/2 oz.)", name: "kuzu powder" },
      { measure: "50 g (1 3/4 oz.)", name: "white sugar" },
      { measure: "500 ml (2 1/2 cups + 2 tbs)", name: "water" },
    ],
    instructions: [
